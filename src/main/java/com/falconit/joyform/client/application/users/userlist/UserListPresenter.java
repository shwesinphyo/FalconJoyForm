...
public class UserListPresenter extends Presenter<UserListPresenter.MyView, UserListPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.userlist)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<UserListPresenter> {
    }
