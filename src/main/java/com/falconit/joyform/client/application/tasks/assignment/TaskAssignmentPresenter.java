...
public class TaskAssignmentPresenter extends Presenter<TaskAssignmentPresenter.MyView, TaskAssignmentPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.taskassignment)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<TaskAssignmentPresenter> {
    }

    @Inject
    TaskAssignmentPresenter(
        EventBus eventBus,
        MyView view,
        MyProxy proxy) {
