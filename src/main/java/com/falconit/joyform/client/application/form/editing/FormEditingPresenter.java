...
public class FormEditingPresenter extends Presenter<FormEditingPresenter.MyView, FormEditingPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.formediting)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<FormEditingPresenter> {
    }

    @Inject
    FormEditingPresenter(
        EventBus eventBus,
        MyView view,
        MyProxy proxy) {
