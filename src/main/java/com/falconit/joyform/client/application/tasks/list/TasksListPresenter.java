...
public class TasksListPresenter extends Presenter<TasksListPresenter.MyView, TasksListPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.tasklist)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<TasksListPresenter> {
    }
