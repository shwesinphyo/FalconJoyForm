...
public class PrivateAppsPresenter extends Presenter<PrivateAppsPresenter.MyView, PrivateAppsPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.privateapps)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<PrivateAppsPresenter> {
    }

    @Inject
    PrivateAppsPresenter(
        EventBus eventBus,
        MyView view,
        MyProxy proxy) {
