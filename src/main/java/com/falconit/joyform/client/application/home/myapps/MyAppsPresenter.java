...
public class MyAppsPresenter extends Presenter<MyAppsPresenter.MyView, MyAppsPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.myapps)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<MyAppsPresenter> {
    }
