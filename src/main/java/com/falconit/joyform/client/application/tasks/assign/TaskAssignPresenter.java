...
public class TaskAssignPresenter extends Presenter<TaskAssignPresenter.MyView, TaskAssignPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.taskassign)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<TaskAssignPresenter> {
    }
