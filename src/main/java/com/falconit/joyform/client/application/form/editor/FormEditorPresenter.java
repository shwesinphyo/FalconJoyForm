...
public class FormEditorPresenter extends Presenter<FormEditorPresenter.MyView, FormEditorPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.formeditor)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<FormEditorPresenter> {
    }
