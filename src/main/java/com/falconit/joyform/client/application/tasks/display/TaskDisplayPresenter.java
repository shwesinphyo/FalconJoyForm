...
public class TaskDisplayPresenter extends Presenter<TaskDisplayPresenter.MyView, TaskDisplayPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.taskdisplay)
    @ProxyStandard
    interface MyProxy extends ProxyPlace<TaskDisplayPresenter> {
    }

    @Inject
    TaskDisplayPresenter(
        EventBus eventBus,
        MyView view,
        MyProxy proxy) {
