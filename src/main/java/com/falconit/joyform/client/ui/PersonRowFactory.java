package com.falconit.joyform.client.ui;
...
public class PersonRowFactory extends RowComponentFactory<Users> {

    @Override
    public RowComponent<Users> generate(DataView dataView, Users model) {
        // We won't change the way it loads the RowComponent
        return super.generate(dataView, model);
    }

    @Override
    public String getCategory(Users model) {
